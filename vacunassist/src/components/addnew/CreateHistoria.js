...
function CreateHistoria() {
    ...
    return (
        <div className='grid text-center  poppinsSemiBold nowrap'>
            <div className='text-white font-bold text-6xl flex-start flex p-4'>Mi historia clínica </div>
          <div className='h-full'>
            <div className='flex flex-col  m-2 p-2  mb-4 rounded h-full'>
                <div className='form-group'>
                    ...
                    <input onChange={handleChange} type='number' placeholder='Ingresá un número' name="cant" value={input.cant} autoComplete="off" className='form-control text-sm text-white w-full py-5 px-4 h-2 rounded m-2 bg-black bg-opacity-30'>
                ...
                <div className='form-group'>
                    ...
                    <input onChange={handleChange} type='date' name="fechaCovid" value={input.fechaCovid} autoComplete="off" className='form-control text-sm text-white w-full py-5 px-4 h-2 rounded m-2 bg-black bg-opacity-30'>
                ...
                <div className='form-group'>
                    ...
                    <input onChange={handleChange} type='date' name="fechaGripe" value={input.fechaGripe} autoComplete="off" className='form-control text-sm text-white w-full py-5 px-4 h-2 rounded m-2 bg-black bg-opacity-30'>
                ...
                <div className='form-group'>
                    ...
                    <input onChange={handleChange} type='date' name="fechaFiebre" value={input.fechaFiebre} autoComplete="off" className='form-control text-sm text-white w-full py-5 px-4 h-2 rounded m-2 bg-black bg-opacity-30'>
                ...
                <div className='form-group'>
                    <span className='text-white font-bold text-2xl flex-start flex  p-2'>
                        ¿Tiene factores preexistentes que lo convierten en un paciente de riesgo?
                    </span>
                    <select onChange={handleChange} value={input.risk} name="risk" className="form-select">
